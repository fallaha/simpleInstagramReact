    ...
    render(){
        return (
            ...
            <div className="searchbar">
                <input type="text" value={this.state.term} onKeyUp={this.checkForKey} onChange={this.searchFormChangeHandler} placeholder="Search"  className="searchbar-input"></input>
            </div>
