    ...
    render(){
        return (
            ...
            <div className="Post-detail-send-comment">
                <input className="commentfield" type="text" placeholder="Add a comment..."></input>
                <input className="sendcommandbtn" type="submit" value="Post"></input>
            </div>
            </div>
        </div>
